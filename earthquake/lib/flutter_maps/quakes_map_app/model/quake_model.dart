import 'package:earthquake/flutter_maps/quakes_map_app/util/types_helper.dart';
...
class Quakes {
  ...
  Quakes({this.type, this.metadata, this.features, this.bbox});

  Quakes.fromJson(Map<String, dynamic> json) {
    type = json['type'];
